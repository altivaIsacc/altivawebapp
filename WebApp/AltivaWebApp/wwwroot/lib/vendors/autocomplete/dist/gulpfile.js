'use strict';
var gulp = require('gulp'), log = require('fancy-log'), colors = require('ansi-colors'), sourcemaps = require('gulp-sourcemaps'), concat = require('gulp-concat'), uglify = require('gulp-uglify'), plumber = require('gulp-plumber'), size = require('gulp-size'), rename = require('gulp-rename'), webpack = require('webpack-stream'), browserSync = require('browser-sync');
