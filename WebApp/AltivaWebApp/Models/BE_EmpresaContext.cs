...
namespace AltivaWebApp.Models
{
    public partial class BE_EmpresaContext : DbContext
    {
        ...
        public virtual DbSet<TbCoPeriodoTrabajoResultados> TbCoPeriodoTrabajoResultados { get; set; }
        ...
        public virtual DbSet<TbPrTipoAjusteInventario> TbPrTipoAjusteInventario { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbCoAsientoContable>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPeriodoTrabajoNavigation)
                    .WithMany(p => p.TbCoAsientoContable)
                    .HasForeignKey(d => d.IdPeriodoTrabajo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tb_CO_AsientoContable_tb_CO_PeriodoTrabajo");
            ...
            modelBuilder.Entity<TbCoCuentaContable>(entity =>
            {
                ...
                entity.Property(e => e.CuentaContablePadre)
                    .IsRequired()
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.DescCuentaPadre)
                    .IsRequired()
                    .HasMaxLength(250)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.IdCuentaPresupuesto).HasDefaultValueSql("('')");

                entity.Property(e => e.IdMonedaEvaluacion).HasDefaultValueSql("((1))");

                entity.Property(e => e.IdTipoConversion).HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<TbCoPeriodoTrabajoResultados>(entity =>
            {
                entity.HasKey(e => e.IdPeriodoTrabajoResultado);

                entity.ToTable("tb_CO_PeriodoTrabajoResultados");

                entity.HasOne(d => d.IdCuentaContableNavigation)
                    .WithMany(p => p.TbCoPeriodoTrabajoResultados)
                    .HasForeignKey(d => d.IdCuentaContable)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tb_CO_PeriodoTrabajoResultados_tb_CO_CuentaContable");

                entity.HasOne(d => d.IdPeriodoTrabajoNavigation)
                    .WithMany(p => p.TbCoPeriodoTrabajoResultados)
                    .HasForeignKey(d => d.IdPeriodoTrabajo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tb_CO_PeriodoTrabajoResultados_tb_CO_PeriodoTrabajo");
            });
            ...
            modelBuilder.Entity<TbPrTipoAjusteInventario>(entity =>
            {
                entity.HasKey(e => e.IdTipoAjusteInventario);

                entity.ToTable("tb_PR_TipoAjusteInventario");
