...
{
    public partial class BE_NUEVAContext : DbContext
    {
        public BE_NUEVAContext()
        {
        }

        public BE_NUEVAContext(DbContextOptions<BE_NUEVAContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=(local);Database=BE_NUEVA;User id=sa;Password=123;");
            }
        }
